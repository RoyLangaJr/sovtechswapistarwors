...
import com.juniorlanga.swapistarwars.adapters.CharactersAdapter
import com.juniorlanga.swapistarwars.databinding.FragmentCharactersBinding
import com.juniorlanga.swapistarwars.viewmodels.CharactersViewModel
...
class CharactersFragment : Fragment() {
    ...
    private val charactersAdapter: CharactersAdapter by lazy {
        CharactersAdapter(CharactersAdapter.OnClickListener { character ->
            val action =
                CharactersFragmentDirections.actionCharectersFragmentToCharectersDetailsFragment(
                    character
                )
